...
import { CURSOR_MARKER, type UIElement, type InteractiveElement, type RenderContext, type KeyEvent } from '../atoms/base.js';
import { truncateText, visibleWidth } from '../atoms/internal-utils.js';
