...
import { AssistantMessage, type AssistantMessageOptions } from '../atoms/assistant-message.js';
import { ToolMessage, type ToolMessageOptions } from '../atoms/tool-message.js';
