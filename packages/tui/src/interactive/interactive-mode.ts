...
import type { UIElement, RenderContext, InteractiveElement, KeyEvent } from '../atoms/base.js';
import { ElementContainer } from '../atoms/base.js';
import { Input, type InputOptions } from '../molecules/input.js';
import { Footer, type FooterItem } from '../molecules/footer.js';
import { SelectList, type SelectItem } from '../molecules/select-list.js';
import { UserMessage, type UserMessageOptions } from '../molecules/user-message.js';
import { AssistantMessage, type AssistantMessageOptions } from '../organisms/assistant-message.js';
import { ToolMessage, type ToolMessageOptions } from '../organisms/tool-message.js';
import { Toast, type ToastOptions } from '../molecules/toast.js';
...
export class InteractiveMode {
  ...
  private createExtensionUIContext(): ExtensionUIContext {
    ...
    return {
      ...
      setStatus: (key: any, text: any) => {
        mode.chatInterface.setRightItems([{ key, label: text }]);
      },
      setWorkingMessage: (message: any) => {
        if (message) {
      ...
      setWorkingIndicator: (opts: any) => {},
      setHiddenThinkingLabel: (label: any) => {},
      setWidget: (key: any, content: any, options?: any) => {
