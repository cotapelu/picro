...
export declare const isSystemTurn: (turn: ConversationTurn) => turn is SystemTurn;
export declare const isUserTurn: (turn: ConversationTurn) => turn is UserTurn;
export declare const isAssistantTurn: (turn: ConversationTurn) => turn is AssistantTurn;
export declare const isToolTurn: (turn: ConversationTurn) => turn is ToolTurn;
...
export type ToolHandler = (args: Record<string, unknown>, context: ToolContext, onProgress?: (update: ToolProgressUpdate) => void | Promise<void>) => string | Promise<string> | void | Promise<void>;
...
export type AgentEvent = AgentStartEvent | AgentEndEvent | TurnStartEvent | TurnEndEvent | MessageStartEvent | MessageUpdateEvent | MessageEndEvent | ToolCallStartEvent | ToolCallEndEvent | ToolProgressEvent | ToolErrorEvent | LLMRequestEvent | LLMResponseEvent | MemoryRetrievalEvent | ErrorEvent;
...
export type StreamFunction = (model: Model, context: {
    systemPrompt: string;
    messages: LLMMessage[];
    tools: ToolDefinition[];
}, options: StreamOptions) => AsyncIterable<LLMStreamEvent>;
