...
| 97     | 2026-06-24 | Function length reduction: extracted `_processTurnWithTools` & `_processTurnWithoutTools` from `executeLoop`, significantly shortened main loop | 3000+      | 0           | 0         |
