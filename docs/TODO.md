...
- ✅ Extension system: basic binding; widgets (above/below) rendered; dialogs (select/confirm/input) implemented; header/footer replacement; autocomplete provider integrated; custom overlay; custom editor component.
...
- ✅ Custom header/footer replacement (setHeader/setFooter)
- ✅ Custom editor component support (setEditorComponent)
