...
- ✅ Extension system: basic binding; widgets (above/below) rendered; dialogs (select/confirm/input) implemented. Still pending: custom overlay, autocomplete provider, header/footer replacement, custom editor component.
