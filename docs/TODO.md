...
- ✅ Extension system: basic binding; widgets (above) rendered; dialogs (select/confirm/input) implemented (basic). Still pending: custom overlay, autocomplete provider, header/footer replacement, custom editor component.
