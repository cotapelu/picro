...
- ✅ Extension system: basic binding; widgets (above/below) rendered; dialogs (select/confirm/input) implemented; header/footer replacement; autocomplete provider integrated. Still pending: custom overlay, custom editor component.
