...
- ✅ Extension system: basic binding; widgets (above/below) rendered; dialogs (select/confirm/input) implemented; header/footer replacement. Still pending: custom overlay, autocomplete provider, custom editor component.
