 ...
 */
export declare function isReadToolResult(result: unknown): boolean;
/**
 ...
 */
export declare function isWriteToolResult(result: unknown): boolean;
/**
 * Check if tool result is from edit tool
 */
export declare function isEditToolResult(result: unknown): boolean;
/**
 * Check if tool result is from grep tool
 */
export declare function isGrepToolResult(result: unknown): boolean;
/**
 * Check if tool result is from find tool
 */
export declare function isFindToolResult(result: unknown): boolean;
/**
 * Check if tool result is from ls tool
 */
export declare function isLsToolResult(result: unknown): boolean;
/**
 * Check if event is a tool call event type
 */
export declare function isToolCallEventType(event: ExtensionEvent): boolean;
